        ...
        >
          ...
          <ul
            className={`flex items-center space-x-11 ${
              isOpen ? "md:flex md:right-0" : "md:hidden"
            } md:flex-col md:absolute m-auto md:top-0 md:right-[-100%] md:w-[78%] md:h-screen md:bg-white transition-transform duration-300`}
          >
